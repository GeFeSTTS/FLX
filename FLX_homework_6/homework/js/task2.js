var amount = parseFloat(prompt("Please, write amount from 0 to 9999999"));
var disc = parseFloat(prompt("Please, write discount from 0 to 99"));
if (amount < 0 || amount > 9999999 || disc < 0 || disc > 99 || isNaN(amount) || isNaN(disc)) {
    alert("Invalid input data");
} else {
    var priceWithDiscount = amount - (amount * disc / 100);
